...
/**
 * Created by MZC on 11/23/2016.
 */

public abstract class CustomPagerAdapterInterface extends PagerAdapter {
    private static final String TAG = "CustomPAI";
    ...
    public CustomPagerAdapterInterface(FragmentManager fm) {
        mFragmentManager = fm;
    }
